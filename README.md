...
* **Cost-Minimized Ingestion Layer**: Optimized to use `claude-3-5-haiku-20241022` with compressed JSON property maps (e.g., swapping verbose structural keys for compact tokens like `yr`, `desc`, `t_name`).
